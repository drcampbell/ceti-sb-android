...
public class ProfileFragment extends Fragment {
	...
	public void renderProfile(View view){
		...
		tv = (TextView) view.findViewById(R.id.textViewEmail);
		tv.setText(SchoolBusiness.getUserAttr("email"));
		tv = (TextView) view.findViewById(R.id.textViewSchool);
		tv.setText("School: " + SchoolBusiness.getUserAttr("school_id"));
		tv = (TextView) view.findViewById(R.id.textViewBio);
		tv.setText("Bio: " + SchoolBusiness.getUserAttr("biography"));
		tv = (TextView) view.findViewById(R.id.textViewJob);
