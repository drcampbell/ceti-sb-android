...
public class RegistrationIntentService extends IntentService {
	...
	private static final String ACTION_FOO = "com.school_business.android.school_business.action.FOO";
	private static final String ACTION_BAZ = "com.school_business.android.school_business.action.BAZ";

	// TODO: Rename parameters
	private static final String EXTRA_PARAM1 = "com.school_business.android.school_business.extra.PARAM1";
	private static final String EXTRA_PARAM2 = "com.school_business.android.school_business.extra.PARAM2";
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			...
			sharedPreferences.edit().putBoolean(SchoolBusiness.SENT_TOKEN_TO_SERVER, true).apply();
			// [END register_for_gcm]
		} catch (Exception e) {
			Log.d(TAG, "Failed to complete token refresh", e);
			// If an exception happens while fetching the new token or updating our registration data
			// on a third-party server, this ensures that we'll attempt the update at a later time.
			sharedPreferences.edit().putBoolean(SchoolBusiness.SENT_TOKEN_TO_SERVER, false).apply();
		}
